...
//		driver.get(LogoutURl);
	...
	public void AddItemToThecart() throws InterruptedException {
		...
		if(LiItem>0) {
			...
			Assert.assertEquals(ActualResult, ExpectedResult, "DODO");
        ...
        Assert.assertEquals(ActualValue, Expectedvalue.toUpperCase());
        boolean Expectedvalueforcheakout = true ; 
       boolean  ActualValueForCheakout = driver.findElement(By.id("cart_checkout1")).isDisplayed();;
       Assert.assertEquals(ActualValueForCheakout, Expectedvalueforcheakout, "Dalia hi");
